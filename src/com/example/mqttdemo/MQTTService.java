...
public class MQTTService extends Service implements MqttSimpleCallback
{
    ...
    // app_id中唯一的变量，用来取references
    public static final String APP_ID = "com.dalelane.mqtt";
    
    // 用来notify activity ui，收到了新的消息     
    ...
    public enum MQTTConnectionStatus 
    {
        ...
        CONNECTING,                         // 正在尝试连接
        CONNECTED,                          // 连接成功
        NOTCONNECTED_WAITINGFORINTERNET,    // 手机没有网络，无法连接
        NOTCONNECTED_USERDISCONNECT,        // 用户明确要求禁止连接
        NOTCONNECTED_DATADISABLED,          // 用户关闭数据流量
        NOTCONNECTED_UNKNOWNREASON          // 未知情况断线
    }
    ...
    // server 的hostname，从preferences中获取
    private String          brokerHostName       = "";
    // topic 匹配字串， 也是从preferences中获取，#表示匹配任何topic
    private String          topicName            = "";    

    
    // broker 的设置，使用默认的基础服务
    ...
    public void onCreate() 
    {
        ...
        Log.d("new log", "start to oncreate");
        ...
        Log.d("new log - brokerhostname", brokerHostName);
...
//            nm.notify(MQTT_NOTIFICATION_ONGOING, notification);
    ...
    private void defineConnectionToBroker(String brokerHostName)
    {
        ...
        try
        {
            ...
            Log.d("start create mqttclient", "wahta hell");
